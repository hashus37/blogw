        ...
        <div class="container-fluid">
            ...
            <table class="table table-bordered">
                ...
                if(isset($_POST["edit_post"])){
                    ...
                    $query2 = "UPDATE  posts SET post_title='$post_title', post_category = '$post_category', post_author = '$post_author', post_tags = '$post_tags', post_text = '$post_text', post_image = '$post_image' WHERE post_id = '$_POST[post_id]'";

                    $edit_post_query = mysqli_query($conn,$query2);
                    header("Location: posts.php");
                }
                                ...
                                <div class="modal-body">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <!-- <input type="text" class="form-control" name="post_category" value=""> -->
