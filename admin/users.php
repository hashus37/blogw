        ...
        <div class="container-fluid">
            ...
            <table class="table table-bordered">
                ...
                if(isset($_POST["edit_user"])){
                    ...
                    $query = "UPDATE users SET user_name = '$user_name', user_email = '$user_email', user_password = '$user_password', user_role = '$user_role' WHERE user_id = '$_POST[user_id]'";
            ...
            <a class="btn btn-primary" data-toggle="modal" data-target="#add_modal">Add new user</a>
